...
$(document).ready(() => {
	...
	$("#wrapped").submit((e) => {
        ...
        if(type=='group_multiple')
        {
            ...
            if(inputAll.length / 2 == inputsValue.length)
            {
        ...
        $("#middle-wizard").append(`
            ...
            <div id="pag${pag}"><div class="step wizard-step">
                ...
                <div class="row">
                    ...
                    <br>
                    <div style="border:1px solid red"> 
                        <p style="font-size:12px; color: red;">JSON : ${JSON.stringify(res, null, '\t')}</p>
                    </div>
                </div>
            </div>`
        )
...
>>>>>>> 09f9f7baa473484cb562f8cd510f85ba36099a44
})